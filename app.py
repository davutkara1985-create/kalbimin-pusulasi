...
def inject_css(style_settings: Optional[Dict[str, Any]] = None) -> None:
    ...
    st.markdown(
        ...
        :root {{
            ...
            /* Form alanı etiketleri: Ad, Soyad, Doğum tarihi, Doğum saati vb.
               Bu değeri değiştirerek tüm form başlıklarının yazı boyutunu tek yerden ayarlayabilirsin. */
            --kp-form-label-size: 0.82rem;
        }}

        html, body, [class*="css"] {{ font-family: var(--kp-font-sans); font-size: calc(16px * var(--kp-font-scale)); }}

        /* Merkezi form etiketi font kontrolü.
           Sadece etiketleri etkiler; input kutusuna yazılan metni değiştirmez.
           Örn: --kp-form-label-size değerini 0.76rem, 0.82rem veya 0.90rem yapabilirsin. */
