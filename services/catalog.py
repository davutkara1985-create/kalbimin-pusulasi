...
MODULES: Dict[str, dict] = {
    ...
    "weekly_report": {
        ...
        "icon": "✦",
        "description": "Premium+ için haftanın aşk enerjisini daha detaylı yorumlar.",
        "category": "Aşk & İlişki",
    ...
    "tarot": {
        "title": "Tarot Falı",
        "icon": "✧",
        "description": "Premium üyeler için 7 kartlık aşk odaklı admin yorumu.",
        "category": "Fal & Kehanet",
        "min_plan": "premium",
        "mode": "manual_request",
        "guest_allowed": False,
    ...
    "katina": {
        "title": "Katina Falı",
        "icon": "🗝",
        "description": "Premium üyeler için romantik bağ odaklı admin Katina yorumu.",
        "category": "Fal & Kehanet",
        "min_plan": "premium",
        "mode": "manual_request",
        "guest_allowed": False,
    ...
    "dream": {
        ...
        "icon": "☾",
        "description": "Premium üyeler için aşk ve bilinçaltı temalı rüya yorumu.",
        "category": "Fal & Kehanet",
        "min_plan": "premium",
        "mode": "manual_request",
        "guest_allowed": False,
    ...
    "soulmate": {
        ...
        "icon": "♁",
        "description": "Premium+ üyeler için özel ruh eşi yorumu ve görsel cevap.",
        "category": "Fal & Kehanet",
        "min_plan": "premium_plus",
        "mode": "manual_request",
        "guest_allowed": False,
    ...
    "meditation": {
        ...
        "icon": "☽",
        "description": "Aşk ve ilişki odağında kalbi sakinleştiren kısa metinleri oku.",
    ...
    "rituals": {
        ...
        "icon": "✺",
        "description": "Romantik niyet, öz değer ve sakinleşme odaklı güvenli ritüelleri görüntüle.",
        "category": "Ruhsal & Zihinsel",
        "min_plan": "free",
        "mode": "content",
        "guest_allowed": True,
